...
if __name__ == '__main__':
    ...
    parser.add_argument("-V", "--activation", default='relu', type=str, help='activation')
    parser.add_argument("--train_dev_split", default=0.2, type=float, help='train dev split')
    parser.add_argument("--val_model_img_size", default=(256, 320), type=tuple, help='validation img_model_size')
    parser.add_argument("--base", default='./', type=str, help='path to the directory where results will be saved')
